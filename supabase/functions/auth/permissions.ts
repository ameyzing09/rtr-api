...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  SUPERADMIN: [
    'tenant:list', 'tenant:create', 'tenant:read', 'tenant:update',
    'tenant:impersonate', 'tenant:status', 'sys:user:list', 'sys:health:read',
    'analytics:read', 'settings:global', 'settings:security', 'settings:db',
  ],
  ADMIN: [
  ...
  VIEWER: [],
  CANDIDATE: [
    'analytics:read', 'application:read', 'application:list',
  ],
};
